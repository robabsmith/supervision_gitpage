...
series r_n' = ( r_iba_f + r_ibl_f) / 2 'Series definition: Rate of return: Mean: FC
...
series pip_iba_fi_h_f = pip_ibl_fi_h 'Series definition: Interest Received: Morgage lending: Fixed rate: FC
series pip_iba_fl_h_f = pip_ibl_fl_h 'Series definition: Interest Received: Morgage lending: Flexible rate: FC
...
model.append s_f = b2_f - r_iba_h(-1) * ibl_f_h(-1) + r_n(-1) * nib_f(-1) + r_eq_dk * neq_f(-1) - r_pen * penl_f(-1) - tax_f + stra_f - cpen_f + r_f_net_error1 + r_f_net_error2 + pip_iba_fi_h_f(-1) + pip_iba_fl_h_f(-1) 'Model equation: Savings: FC
...
model.append pip_iba_fi_h_f = pip_ibl_fi_h 'Model equation: Interest Received: Morgage lending: Fixed rate: FC
model.append pip_iba_fl_h_f = pip_ibl_fl_h 'Model equation: Interest Received: Morgage lending: Flexible rate: FC
...
' 'Preserve values: Save original value to baseline
'smpl @all
'genr r_ibl_fl_h_0 = r_ibl_fl_h 'Preserve values: Save original value to baseline
'genr r_iba_h_0 = r_iba_h 'Preserve values: Save original value to baseline
'genr r_ibl_fi_h_0 = r_ibl_fi_h 'Preserve values: Save original value to baseline
'genr r_n_0 = r_n 'Preserve values: Save original value to baseline

 'Shock: Introduce shock
smpl 2020 @last
r_ibl_fl_h = 0.02 + r_ibl_fl_h 'Shock: Introduce shock
r_iba_h = 0.02 + r_iba_h 'Shock: Introduce shock
r_ibl_fi_h = 0.005 + r_ibl_fi_h 'Shock: Introduce shock
r_n = (0.02 * (1-alpha)) + (0.005 * alpha)  + r_n 'Shock: Introduce shock
...
model.solve(i = p)
 ...
 'Preserve values: Save Scenario 1 values to new variables
genr r_ibl_fl_h_1 = r_ibl_fl_h 'Preserve values: Save Scenario 1 values to new variables
genr r_iba_h_1 = r_iba_h 'Preserve values: Save Scenario 1 values to new variables
genr r_ibl_fi_h_1 = r_ibl_fi_h 'Preserve values: Save Scenario 1 values to new variables
genr r_n_1 = r_n 'Preserve values: Save Scenario 1 values to new variables
...
' 'Preserve values: Save original value to baseline
'smpl @all
'genr zz_i_0 = zz_i 'Preserve values: Save original value to baseline

 'Shock: Introduce shock
smpl 2030 @last
zz_i = zz_i * 0.8 'Shock: Introduce shock
...
model.solve(i = p)
 ...
 'Preserve values: Save Scenario 2 values to new variables
genr zz_i_2 = zz_i 'Preserve values: Save Scenario 2 values to a new variable
...
'##############################
'Scenario 3: Change in  alpha from 2017
'##############################


' 'Preserve values: Save original value to baseline
'smpl @all
'genr alpha_0 = alpha 'Preserve values: Save original value to baseline

 'Shock: Introduce shock
smpl 2017 @last
alpha = 0.8 'Shock: Introduce shock
...
model.solve(i = p)
 ...
 'Preserve values: Save Scenario 3 values to new variables
genr alpha_3 = alpha 'Preserve values: Save Scenario 3 values to new variables
